...
ns.RegisterLocale("deDE", {
	...
	["The preview keeps its size when you change a layout, and copying starts empty."] = "Die Vorschau behält ihre Größe, wenn du das Layout wechselst, und Kopieren startet leer.",
	...
	["The destination cells in that dialog looked switched off: an empty cell no longer carries a faded check mark, and the cells stand out from the dialog behind them."] = "Die Ziel-Felder in diesem Dialog sahen aus wie deaktiviert: Ein leeres Feld trägt kein blasses Häkchen mehr, und die Felder heben sich vom Dialog dahinter ab.",
