...
ns.RegisterLocale("deDE", {
	...
	["Mark what you can dispel"] = "Selbst Entfernbares hervorheben",
	["Highlights debuffs your own class can remove in a colour of their own, so a wider scope still tells your work from somebody else's."] = "Hebt Debuffs, die deine Klasse entfernen kann, in einer eigenen Farbe hervor — so bleibt auch bei größerem Umfang erkennbar, was deine Aufgabe ist.",
	["Mine"] = "Mich",
	...
	["Which debuffs are shown. Raid-relevant + dispellable adds everything your group can dispel — no matter who has to do it — so a dispel highlight never stands there without an icon. All drops the curation and shows every debuff."] = "Welche Debuffs gezeigt werden. Raid-relevant + dispelbar nimmt alles dazu, was deine Gruppe entfernen kann — egal wer es tun muss — damit eine Dispel-Hervorhebung nie ohne Icon dasteht. Alle verzichtet auf die Auswahl und zeigt jeden Debuff.",
	["Position (anchor)"] = "Position (Anker)",
	["Growth direction"] = "Wachstumsrichtung",
	["Placement"] = "Platzierung",
	["Offset X"] = "Versatz X",
	["Offset Y"] = "Versatz Y",
	["Raid-relevant + dispellable"] = "Raid-relevant + dispelbar",
	["All"] = "Alle",
	...
	["Marks the icon while re-casting would carry the remaining time over (pandemic window). Needs patch 12.1. Applies to raid and group."] = "Markiert das Icon, solange ein neuer Zauber die Restzeit mitnimmt (Pandemie-Fenster). Braucht Patch 12.1. Gilt für Raid und Gruppe.",
	["Cues"] = "Hinweise",
	["Extra hints on the icon"] = "Zusätzliche Hinweise auf dem Icon",
	...
	["Quick gossip everywhere"] = "Schnelles Gespräch überall",
	["Extends quick gossip to the open world. Careful: flight masters, vendors and quest NPCs with a single talk option are then taken instantly too — hold Shift to read one."] = "Erweitert das schnelle Gespräch auf die offene Welt. Achtung: Flugmeister, Händler und Quest-NPCs mit nur einer Gesprächsoption werden dann ebenfalls sofort angenommen — zum Lesen Umschalt gedrückt halten.",
	...
	["Shared battle-res pool as an icon: charges and recharge time while a key or raid boss runs. Outside that it follows your own battle res, if you have one. Always on screen, with the remaining time right on the icon. Place it via Edit Mode."] = "Geteilter Kampfrez-Pool als Icon: Ladungen und Aufladezeit, solange ein Schlüsselstein läuft oder ein Raid-Boss im Kampf ist. Außerhalb davon folgt es deinem eigenen Kampfrez, falls du einen hast. Immer sichtbar, die Restzeit steht direkt im Icon. Platzieren über den Edit-Modus.",
	["Bloodlust tracker"] = "Bloodlust-Tracker",
	["Always on screen. While Bloodlust is running the icon stays bright and counts the burst window down; afterwards it switches to the cooldown and shows how long you stay Sated. Place it via Edit Mode."] = "Immer sichtbar. Solange Bloodlust läuft, bleibt das Icon hell und zählt das Burst-Fenster runter; danach wechselt es auf die Abklingzeit und zeigt, wie lange du übersättigt (Sated) bist. Platzieren über den Edit-Modus.",
	["Off: both trackers stay on screen everywhere. On: they only appear inside dungeons and raids."] = "Aus: Beide Tracker bleiben überall sichtbar. An: Sie erscheinen nur in Dungeons und Raids.",
	["Combat res"] = "Kampfrez",
